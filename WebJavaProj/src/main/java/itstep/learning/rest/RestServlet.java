...
public class RestServlet extends HttpServlet {
    ...
    protected void sendResponse( int code, Object data, int maxAge ) throws IOException {
        if (code > 0) restResponse.setStatus( new RestStatus( code ) );
        if (data != null) restResponse.setData( data );
    ...
    protected void sendResponse( Object data ) throws IOException {
        if (restResponse.getStatus() == null) this.sendResponse( 200, data );
        else this.sendResponse( -1, data );
    }
    ...
    protected void sendResponse() throws IOException {
        if (restResponse.getStatus() == null) this.sendResponse( 200 );
        else this.sendResponse( -1 );
    }
}