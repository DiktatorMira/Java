...
@Singleton public class CategoryServlet extends RestServlet {
    private final Logger logger;
    private final FormParseService formParseService;
    private final StorageService storageService;
    private final CategoryDao categoryDao;

    @Inject public CategoryServlet(Logger logger, FormParseService formParseService, StorageService storageService, CategoryDao categoryDao) {
        this.logger = logger;
    ...
    @Override protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            data = storageService.saveFile(formParseResult.getFiles().get("category-image"));
        ...
        if (( category = categoryDao.create(category)) != null) super.sendResponse(201, category);
        else super.sendResponse(500, "Error creating category");
    }
}