...
@Singleton public class ProductServlet extends RestServlet {
    private final Logger logger;
    private final FormParseService formParseService;
    private final StorageService storageService;
    private final ProductDao productDao;

    @Inject public ProductServlet(Logger logger, FormParseService formParseService, StorageService storageService, ProductDao productDao) {
        this.logger = logger;
