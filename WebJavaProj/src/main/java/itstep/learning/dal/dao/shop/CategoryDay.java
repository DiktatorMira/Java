...
@Singleton public class CategoryDao {
    private final Connection connection;
    private final Logger logger;

    @Inject public CategoryDao( Connection connection, Logger logger ) {
    ...
    public List<Category> all() {
        ...
        try (Statement statement = connection.createStatement()) {
            ...
            while (resultSet.next()) categories.add(new Category(resultSet)) ;
